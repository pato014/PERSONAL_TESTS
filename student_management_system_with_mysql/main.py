...
class DatabaseConnection:
    def __init__(self, host="localhost", user="root", password="NIKApato1499", database="school"):
        self.host = host
        self.user = user
...
class MainWindow(QMainWindow):
    ...
    def load_data(self):
        connection = DatabaseConnection().conncet()
...
class EditDialog(QDialog):
    ...
    def edit_student(self):
        conn = DatabaseConnection().conncet()
        cursor = conn.cursor()
...
class DeleteDialog(QDialog):
    def __init__(self):
        ...
        confirmation = QLabel("Are you sure you want to delete selected data?")
        yes = QPushButton("Yes")
        no = QPushButton("No")
...
class SearchDialog(QDialog):
    ...
    def search_student(self):
        ...
        con = DatabaseConnection().conncet()
        cursor = con.cursor()
